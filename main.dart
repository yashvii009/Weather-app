...
dynamic dynamicDirective(dynamic dynamicImport) {
  // Function logic here
}
...
void initState() {
super.initState();
_apiKey = 'https://api.openweathermap.org/data/3.0/onecall?lat={lat}&lon={lon}&exclude={part}&app id={API key}';
...
Uri.parse(
'https://api.openweathermap.org/data/2.5/weather?q=$_selectedCity&app id=$_apiKey&units=$_unit'),
);
